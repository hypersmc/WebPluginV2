 ...
 * v1.0.0
 */
public class PHPWebServerVel extends Thread{
    Socket socket;
    WebCoreProxyVel main;
    String DEFAULT_FILE = "index.php";
    public PHPWebServerVel(Socket socket, WebCoreProxyVel main) {
        this.socket = socket;
        this.main = main;
    }
...
//            out.println("Content-length: " + fileLength + "\r\n");
    ...
    /**
     * old code I want to keep in case i need it!
     */
    //    private void processRequest(BufferedReader in, PrintWriter out, BufferedOutputStream dataOut) {
//        String fileRequested;
//        try {
...
//            main.getLogger().info("Method: " + method);
//            fileRequested = parse.nextToken().toLowerCase();
//            String s;
//            int counter = 0, contentLength = 0;
//            try {
...
//
//            if (fileRequested.endsWith(".php")) {
//                // Execute PHP script and get the output
//                String phpOutput = executePHP(file);
//                fileLength = phpOutput.length();
//                content = "text/html";  // PHP output is usually HTML
//
//                // Send HTTP Headers
//                out.write("HTTP/1.1 200 OK\r\n");
//                out.write("Server: Java HTTP Server from WebPlugin : " + main.pluginversion + "\r\n");
...
//                out.flush();
//
//                // Send PHP output as response
//                dataOut.write(phpOutput.getBytes(), 0, fileLength);
//                dataOut.flush();
//            } else {
//                // Handle non-PHP files (static content)
//                byte[] fileData = readFileData(file, fileLength);
//
//                // Send HTTP Headers
//                out.write("HTTP/1.1 200 OK\r\n");
